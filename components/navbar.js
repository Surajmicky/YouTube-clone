...
function navbar() {
  return `  <div id="navbar">
   ...
   <div id="searchicon"><img class="navimg"  src="./icons/search.png" alt=""></div>
</div>
<div><img  style="height: 20px; padding-bottom: 5px;"  class="navimg" src="/youtube_app/icons/mic.png" alt=""></div>
<div id="navcreate">
    <div><img class="create"  src="./icons/video.png" alt=""></div>
          <div><img class="create"  src="./icons/grid.png" alt=""></div>
          <div><img class="create"  src="./icons/bell.png" alt=""></div>
